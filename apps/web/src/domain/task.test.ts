...
describe('parseNewTask — validación de creación', () => {
  ...
  it('acepta la falta de fecha: la tarea es "para hacer ya" (FR-003)', () => {
    ...
    expect(parsed).toEqual({ name: 'Cambiar filtro', taskDate: null, nucleusId: null, description: null, urgent: false, recurrence: null })
  })
  ...
  it('acepta una entrada válida y recorta el nombre', () => {
    ...
    expect(parsed).toEqual({ name: 'Cambiar filtro', taskDate: '2026-06-15', nucleusId: null, description: null, urgent: false, recurrence: null })
  })
